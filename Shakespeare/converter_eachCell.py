...
csv_output_path = '/Users/Jiwoo/Desktop/Project/converter/Sherlock.csv'

# List to store extracted text data
data = []

# Define a regular expression to split words and special characters
word_split_pattern = re.compile(r"([A-Za-z]+|[.,!?;:])")
        ...
        if text:
            ...
            for line in lines:
                ...
                if not line.strip().isdigit():
                    ...
                    words_and_punctuation = word_split_pattern.findall(line.strip())  # Find all words and punctuation
